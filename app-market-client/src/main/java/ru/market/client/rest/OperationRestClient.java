...
public interface OperationRestClient {
    OperationDTO enrollment(OperationEnrollDebitDTO enrollDebitDTO) throws RestClientException;
    OperationDTO debit(OperationEnrollDebitDTO enrollDebitDTO) throws RestClientException;
    OperationDTO transfer(OperationTransferDTO transferDTO) throws RestClientException;
