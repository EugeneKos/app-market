...
import ru.market.domain.validator.limit.CostLimitValidator;
...
public class ValidatorConfiguration {
    ...
    @Bean
    public CommonValidator<CostLimit> costLimitValidator(CostLimitRepository costLimitRepository){
        return new CostLimitValidator(costLimitRepository);
    }
}
